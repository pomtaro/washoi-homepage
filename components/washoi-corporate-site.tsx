...
import { Code, FileSpreadsheet, Zap, Puzzle, BarChart, Target, PenTool, Lightbulb, CheckCircle } from "lucide-react"
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card className="p-8">
                <CardContent className="flex flex-col items-center p-0">
                  ...
                  <p className="text-sm">
                    2017年に京都大学大学院を修了。同年ソニー株式会社に入社し、5G通信用半導体デバイスの研究に従事。半導体の加工形状に関する特許を取得し、研究計画の効率化や分析自動化に取り組んだ。2018年にライフシフト株式会社に入社し、アパレルEC事業のプロジェクトリーダーとして、SNSマーケティング、業務自動化、配送物流の構築、分析ツールの開発、広告運用に携わる。2022年に株式会社Washoiに入社し、顧客の業務効率化を目的とした業務アプリケーションの開発に従事。理論だけでなく実体験に基づくアプローチで、他社の業務効率化に貢献している。
                  </p>
                </CardContent>
              </Card>
              <Card className="p-8">
                <CardContent className="flex flex-col items-center p-0">
                  ...
                  <p className="text-sm">
                    2017年に東京大学大学院を修了。同年、JFEスチール株式会社に入社し、圧延工場において能率向上に取り組み、年間数千万円規模のコスト削減を実現。また、自動車向けの難圧延材における圧延トラブル削減に貢献。2021年にMeguru AI株式会社を創業し、不動産業者向けのAIシステム開発に従事。中小企業向けの営業DXにも携わり、提携企業の売上を5倍に拡大させた。2024年には株式会社Washoiに入社し、現場ヒアリングを通じたコンサルティングや業務アプリケーション開発に従事している。
                  </p>
                </CardContent>
              </Card>
              <Card className="p-8">
                <CardContent className="flex flex-col items-center p-0">
                  ...
                  <p className="text-sm">
                    2017年に京都大学大学院を修了。同年、三菱電機株式会社に入社し、鉄道用変電所建設プロジェクトのマネジメントおよび電気設計に従事。プロジェクトの計画策定から運営、電気設備の仕様調整、顧客への提案活動を担当し、品質・コスト・納期の最適化を図り、顧客満足度の向上に貢献。また、業務上の課題や顧客のニーズを的確に把握し、改善に繋げるノウハウを習得。2024年には株式会社Washoiに入社し、生成AIを活用したサービス開発に携わっている。
                  </p>
                </CardContent>
              </Card>
            </div>
